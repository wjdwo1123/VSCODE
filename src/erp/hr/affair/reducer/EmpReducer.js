...
//============================== 사원 등록 성훈 시작===============================================//
export const SEARCH_DIVISION_CODE_REQUEST = 'src/erp/hr/Saga/Saga/SEARCH_DIVISION_CODE_REQUEST';        // 부서번호 호출
export const SEARCH_DIVISION_CODE_SUCCESS ='src/erp/hr/Saga/Saga/SEARCH_DIVISION_CODE_REQUEST_SUCCESS'; //리듀서에서 사용
export const SEARCH_DIVISION_CODE_FAILURE ='src/erp/hr/Saga/Saga/SEARCH_DIVISION_CODE_REQUEST_FAILURE';
