...
import Guhyeon from 'C:/Users/JJ/Desktop/68REACT/68REACT/68REACT/src/erp/hr/affair/page/EmpDetailed/EmpDetailedContainer';
...
function RootRoute() {
    return (
        <>
            ...
            <Switch>
                {/* 메 인 */}
                <Route exact path="/app/dashboard/Guhyeon" component={Guhyeon} />
                {/* 메 인 */}
            </Switch>
            <Switch>
                {/* 회 계 */}
